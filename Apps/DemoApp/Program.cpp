...
int main(int argc, char* argv[])
{
    ...
    switch (parseResult) {
    case App::SUCCESS_RESULT: break;
    case App::ERROR_RESULT: Log::E("App::ParseArguments failed!\n"); return 1;
    case App::QUIT_RESULT: return 0;
    }
    ...
    ctx.window = SDL_CreateWindow(
        "splatapult", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, WIDTH, HEIGHT, windowFlags);
    ...
    app.OnQuit([&shouldQuit]() { shouldQuit = true; });
